      ...
      <Page key={product.id} size="A4" style={styles.page}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            ...
            <View style={styles.tableCol}><Text>Cost Per Kg</Text></View>
          </View>
          {/* Table rows for ingredients */}
          {product?.ingredients?.map((ingredient, index) => (
            <View key={index} style={styles.tableRow}>
              <View style={styles.tableCol}><Text>{ingredient?.ingredient?.name}</Text></View>
              <View style={styles.tableCol}><Text>{ingredient?.quantity}</Text></View>
              <View style={styles.tableCol}><Text>{ingredient?.ingredient.costPerKg}</Text></View>
            </View>
          ))}
        </View>
      </Page>
